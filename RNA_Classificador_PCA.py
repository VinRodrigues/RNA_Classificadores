...
Classificador = MLPClassifier(hidden_layer_sizes = (2000,46,23,6), alpha=1, max_iter=10000)
...
ClassificadorPCA = MLPClassifier(hidden_layer_sizes = (1500, 1000,500, 300,100,50), alpha=1, max_iter=1000000)
ClassificadorPCA.fit(pca_features,target)

#ClassificadorPCA = MLPClassifier(hidden_layer_sizes = (1400, 1000,500, 300,100), alpha=1, max_iter=100000) deu certo
